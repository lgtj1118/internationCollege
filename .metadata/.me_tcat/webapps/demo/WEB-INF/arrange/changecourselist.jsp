...
<html>
  <head>
	...
	function f_initGrid() {
		g = manager = $("#maingrid").ligerGrid(
				...
				editor: { type: 'select', data: StatusData, valueField: 'status' },
					...
					checkbox:false,
			        rownumbers:true,
					url :"${pageContext.request.contextPath}/system/Manage_prvChangeCourseList.action",
					width : '100%'
				});
	}
	var m;
	...
	function emptyApply(){
	 var str = "${pageContext.request.contextPath}/system/Manage_emptyroomApply.action";
	 m=$.ligerDialog.open({
			url : str,
			height : 400,
			width : 640,
	...
	<body style="padding: 2px">		
		<div style="margin-top:10px;" >&nbsp;<font size="2">&nbsp;&nbsp;注：<br>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 申请调课批复前，请先查看申请调课日期相关教室是否已安排课程。</font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 如申请<strong>调课成功</strong>，请及时通知调课班级。<br></div>
		<a class="l-button" style="width:100px;float:left; margin:3px;" onclick="apply()">与现有课程调换</a>
		<a class="l-button" style="width:100px;float:left; margin:3px;" onclick="emptyApply()">调换至空闲教室</a>
