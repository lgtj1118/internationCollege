...
var managers, gs;
	...
	function batch(){
	var str = "/demo/system/Manage_batchSemesterCourse.action";
		m=$.ligerDialog.open({		   
			url : str,
			height : 400,
			width : 800,
	...
	function f_next(){
	   ...
	   var str = "${pageContext.request.contextPath}/system/Manage_semestercoursesetteacher.action?semestertext="+  encodeURI(encodeURI(semester));
...
.l-button-l{
  ...
  margin-top:-5px;
	...
	<body style="padding: 2px">	
	    <div style="margin: 10px;"><font size="4"><strong>注：</strong></font><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 选择课程后，点击底部下一步按钮，即可设置本学期，开课课程详细信息。 
	    	<a class="l-button" onclick="batch()"><strong>批量上传</strong></a>
	    </div>			
		...
		<div id="maingrid2" align="right" style="margin: 4px;margin-right:10px;margin-top:-10px; padding: 0; margin-left: 10px; float: left;" ></div>		 
	</body>
</html>
