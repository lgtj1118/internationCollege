   ...
   $(f_initGrid);
	...
	function f_initGrid() {
		g = manager = $("#maingrid").ligerGrid(
			...
			}, {display : '护照号', name : 'passport',  minWidth : 120 
	...
	var m;
	function addstu(){	
	var str = "${pageContext.request.contextPath}/system/Stu_classstubeginadd.action?cls.id="+$("#classid").val();
		m=$.ligerDialog.open({
			url : str,
			height : 500,
			width : 700,
	...
	var str = "${pageContext.request.contextPath}/system/Stu_classstubatchadd.action?cls.id="+$("#classid").val();
		m=$.ligerDialog.open({
			url : str,
			height : 500,
			width : 800,
