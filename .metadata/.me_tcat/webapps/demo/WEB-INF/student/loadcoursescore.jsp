...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function f_initGrid() {
		g = manager = $("#maingrid").ligerGrid(
				...
				editor: { type: 'text'}
					...
					render : function() {
						var h = "";
						h += "<a style='color:#000;' href='javascript:courseclassscoreload("+ ")'>查看成绩</a> ";
						return h;
					}
			} ],
    ...
    function courseclassscoreload(){
     var row = manager.getSelectedRow();
	 	if (!row) {
			alert('请选择班级！');
			return;
		}
     var str = "${pageContext.request.contextPath}/system/Manage_courseclassscoreload.action?cls.id="+row.Classid+"&course.num="+$("#coursenum").val()+"&semChosenCourse.semester="+$("#semester").val();
	...
	<body style="padding: 2px">
        <br/>
        <input id="semester" value="${seme}" type="hidden" />
