	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="telephone"id="telephone" value="${leaves.telephone }" /></td>
			...
			<tr>
				...
				<th align="left" class="l-table-edit-td" colspan="5"><textarea id="reason"  style="width: 400px;height: 200px;" onchange="check()" >${leaves.leavereason }</textarea></th>
			</tr>		 
