...
<div class="main">
 <div class="top">
   ...
   <div class="headtitle"><font size="6" face="华文新魏" color="#ffffff"><span style="font-size: 50px;" >&nbsp;&nbsp;天津工业大学</span><br /><span>国际教育学院教学服务系统</span> </font></div>
 </div>	
	<div class="content">
		...
		<s:form action="main" method="post" id="loginForm" namespace="/">
			<fieldset>
			   <div class="input" >
					...
					<select  name="user.roles.rolerank"style="height:41px;width:190px;margin-top:-5px;border: 1.1em;">  
				...
				<div class="input">
					<input class="input_all name" name="user.usernum"  id="name" placeholder="用户名" type="text" onFocus="this.className='input_all name_now';" onBlur="this.className='input_all name'" maxLength="24"  />
				</div>
				<div class="input">
