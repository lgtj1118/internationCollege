...
public final class courseclasslist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String  s= (String) request.getAttribute("classlist");
      ...
      out.write("\t\t\t\t\t\tvar h = \"\";\r\n");
      out.write("\t\t\t\t\t\th += \"<a style='color:#000;' href='javascript:attendencestu(\"+ \")'>考勤</a> \";\r\n");
      out.write("\t\t\t\t\t\treturn h;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t} ],\r\n");
      ...
      out.write("\t\t\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("    function attendencestu(){\r\n");
      ...
      out.write("/system/Manage_courseclassstulist.action?cls.id=\"+row.Classid+\"&course.num=\"+$(\"#courseid\").val()+\"&course.coursename=\"+$(\"#coursename\").val();\r\n");
      out.write("\t\tm=$.ligerDialog.open({\r\n");
      out.write("\t\t\turl : str,\r\n");
      out.write("\t\t\theight : 650,\r\n");
      out.write("\t\t\twidth : 1000,\r\n");
      out.write("\t\t\ttitle:'班级考勤',\r\n");
      ...
      out.write("\t\t<br/><input id=\"courseid\" value=\"");
      ...
      out.write("\t\t<input id=\"coursename\" value=\"");
