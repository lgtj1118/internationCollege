...
public final class emptyRoomApply_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\tvar newNum = $(\"#roomName\").val();\r\n");
      out.write("\t\t\tvar today = new Date();\r\n");
      ...
      out.write("\t\t\tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Manage_chkNewEmptyRoomSlot.action?plandate=\" + plandate\r\n");
      ...
      out.write("\t\t\t\t+ \"&oldnum=\" + oldNum + \"&adjustReason=\" + encodeURI(encodeURI(reason)) + \"&origndate=\" + origndate\r\n");
      out.write("\t\t\t\t+ \"&plandate=\" + plandate + \"&oldSlot=\" + $(\"#oldSlot\").val() + \"&newSlot=\" + $(\"#newSlot\").val()\r\n");
      out.write("\t\t\t\t+ \"&newRoomNum=\" + $(\"#roomName\").val() + \"&oldRoomNum=aa\";\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t//alert(url);\r\n");
      ...
      out.write("  <body>\r\n");
      out.write("  \r\n");
      out.write("    <table cellpadding=\"0\" cellspacing=\"0\" class=\"l-table-edit\" style=\"font-size:12px\">\r\n");
      out.write("    \t<tr>\r\n");
      ...
      out.write("    \t\t<td align=\"center\" class=\"l-table-edit-td\"><select class=\"link\" id=\"oldSlot\"></select></td>\r\n");
      ...
      out.write("    \t</tr>\r\n");
      out.write("    \t<tr>\r\n");
      out.write("    \t\t<td align=\"center\" class=\"l-table-edit-td\">教室列表</td>\r\n");
      out.write("    \t\t<td align=\"center\" class=\"l-table-edit-td\">\r\n");
      out.write("    \t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<select id=\"roomName\" onchange=\"tchange2()\" class=\"link\" >\r\n");
      out.write("\t\t\t\t");
      ...
      out.write('>');
      out.write(' ');
      out.print(s.getRoomplace() + s.getRoomname() );
      out.write(" </option>\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\t\r\n");
      out.write("\t\t\t\t</select></td>\r\n");
      out.write("\t\t\t<td align=\"center\" class=\"l-table-edit-td\">当天可用节次</td>\r\n");
      out.write("\t\t\t<td align=\"center\" class=\"l-table-edit-td\"><select id=\"newSlot\" class=\"link\"></select></td>\r\n");
      out.write("\t\t\t<td align=\"left\"></td>\r\n");
      out.write("    \t</tr>\r\n");
      out.write("\r\n");
      out.write("    \t<tr>\r\n");
