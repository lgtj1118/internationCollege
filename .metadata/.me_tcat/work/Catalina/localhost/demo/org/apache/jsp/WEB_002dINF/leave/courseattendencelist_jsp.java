...
public final class courseattendencelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String ssss=(String) request.getAttribute("checkway");
      ...
      out.write("\t\t\t\t\t\tvar h = \"\";\r\n");
      out.write("\t\t\t\t\t\th += \"<a style='color:#000;' href='javascript:courseattendence(\"+ \")'>考勤</a> \";\r\n");
      out.write("\t\t\t\t\t\treturn h;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t} ],\r\n");
      ...
      out.write("\t    var str = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Manage_tabcourseattendenceload?course.num=\"+row.num;\r\n");
