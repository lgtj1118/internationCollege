...
public final class menuadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("/system/Menu_menuendadd.action?menu.namenav=\"+ encodeURI(encodeURI($(\"#name\").val()))\r\n");
      out.write("\t\t        +\"&menu.enname=\"+ encodeURI(encodeURI($(\"#enname\").val()))\r\n");
      out.write("\t\t        +\"&id=\"+ encodeURI(encodeURI($(\"#parentnav\").val()))\r\n");
      out.write("\t\t        +\"&menu.menuurl=\"+ encodeURI(encodeURI($(\"#menuurl\").val())),null,function(){\r\n");
      ...
      out.write("\t     $(\"#result\").html(\"菜单名不能为空！\");\r\n");
      out.write("\t     $(\"#result\").shou();\r\n");
      out.write("\t     flg=false;\r\n");
      out.write("\t  }else{\r\n");
      out.write("\t    $(\"#result\").hide();\r\n");
      out.write("\t    var reg = /^[\\u4e00-\\u9fa5]{2,}$/gi;\r\n");
      out.write("\t     if(!reg.test(name)){\r\n");
      out.write("\t         $(\"#result\").html(\"菜单名只能为两个字符以上的中文！\");\r\n");
      ...
      out.write("\t  var name = $(\"#enname\").val();\r\n");
      out.write("\t  if(name.length==0){\r\n");
      out.write("\t     $(\"#result1\").html(\"英文名称不能为空！\");\r\n");
      out.write("\t     $(\"#result1\").shou();\r\n");
      out.write("\t     flg1=false;\r\n");
      out.write("\t  }else{\r\n");
      out.write("\t    $(\"#result1\").hide();\r\n");
      out.write("\t    var reg = /^[a-zA-z]{2,}$/;\r\n");
      out.write("\t     if(!reg.test(name)){\r\n");
      out.write("\t         $(\"#result1\").html(\"英文名只能为两个字符以上的英文！\");\r\n");
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">父节点:</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\">\r\n");
      out.write("\t\t\t\t<select name=\"parentnav\" id=\"parentnav\" ltype=\"select\">\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">节点名称:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"name\"type=\"text\"  id=\"name\" ltype=\"text\" onchange=\"checkname()\" placeholder=\"菜单名称\"  /></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"><div id=\"result\"  style=\"color: red\" ></div></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">英文名称:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"enname\"type=\"text\" id=\"enname\" placeholder=\"菜单英文名称\" onchange=\"checkengname()\" ltype=\"text\" /></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"><div id=\"result1\"  style=\"color: red\" ></div></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">地址链接:</td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"menuurl\"type=\"text\" id=\"menuurl\" ltype=\"text\" placeholder=\"菜单链接\"/></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
  ...
  private boolean _jspx_meth_s_005fiterator_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/manage/menuadd.jsp(154,6) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f0.setValue("#menulist");
    // /WEB-INF/manage/menuadd.jsp(154,6) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/manage/menuadd.jsp(155,22) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/manage/menuadd.jsp(155,52) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fproperty_005f1.setValue("#gg.namenav");
