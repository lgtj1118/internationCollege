...
public final class semesterclassselect_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String  s= (String) request.getAttribute("classlist");
      ...
      out.write("\t\tif (!row) {\r\n");
      out.write("\t\t\talert('请至少选定一个班级！');\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar rows = g.getCheckedRows();\r\n");
      out.write("        var str = \"\";\r\n");
      out.write("        $(rows).each(function(){\r\n");
      out.write("           str += this.Classid +\",\";\r\n");
      out.write("        });\r\n");
      out.write("        $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Manage_semestercourseclassset.action?ids=\"+ str+\"&semChosenCourse.id=\"+$(\"#semestercourseid\").val(),null,function(){\r\n");
      ...
      out.write("\t\t\t<a class=\"l-button\" style=\"width:60px;float:left; margin:3px;\" onclick=\"addclass()\">选&nbsp;&nbsp;定</a>\t\t\t\r\n");
