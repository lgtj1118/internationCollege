...
public final class classstudentadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t\t\tvar test = (flg)&&(flg1)&&(flg2)&&(flg3)&&(flg5)&&(flg6)&&(flg7)&&(flg8)&&(flg9)&&(flgtest)&&(flgtest1)&&(flgt);\r\n");
      out.write("\t\t\t\tif(test){\t\t\t\r\n");
      ...
      out.write("/system/Stu_stuendadd.action?stu.stuid=\"+ $(\"#stunum\").val()\r\n");
      ...
      out.write("\t\t\t$(\"#result2\").html(\"护照不能包含中文！\");\r\n");
      out.write("\t\t\t$(\"#result2\").show();\r\n");
      out.write("\t\t\tflg2 = false;\r\n");
      out.write("\t\t\t//document.regFrm.username.focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      ...
      out.write("\t\t    $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Stu_stucheck.action?stu.passport=\"\r\n");
      out.write("\t\t\t\t\t\t+ $(\"#passport\").val(), null, function(data) {\r\n");
      ...
      out.write("\t   }else{\r\n");
      out.write("\t      $(\"#result3\").hide();\r\n");
      out.write("\t      if(stunum.length!=12){\r\n");
      out.write("\t         $(\"#result3\").html(\"学号只能为12位有效数字！\");\r\n");
      out.write("\t\t     $(\"#result3\").show();\r\n");
      out.write("\t\t     flg3 = false;\r\n");
      out.write("\t\t     return false; \r\n");
      out.write("\t      }else{\r\n");
      ...
      out.write("\t         $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Stu_stucheckstunum.action?stu.stuid=\"\r\n");
      out.write("\t\t\t\t\t\t+ $(\"#stunum\").val(), null, function(data) {\r\n");
      out.write("\t\t\t\t\tif (data == \"fail\") {\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t<table cellpadding=\"0\" cellspacing=\"0\" class=\"l-table-edit\" align=\"center\" >\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">英文名:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"firstname\"type=\"text\" id=\"firstname\" ltype=\"text\" onchange=\"checkengname()\" /></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">英文姓:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"lastname\"type=\"text\" id=\"lastname\" ltype=\"text\" onchange=\"checkengname()\" /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"stuname\"type=\"text\" onchange=\"checkname()\" id=\"stuname\" ltype=\"text\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"nation\"type=\"text\" id=\"nation\" onchange=\"checknation()\" ltype=\"text\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"passport\"type=\"text\" onchange=\"checkpassport()\" id=\"passport\" ltype=\"text\" placeholder=\"请输入护照号\" /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"stunum\"type=\"text\" id=\"stunum\" onchange=\"checknum()\" ltype=\"text\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"studenttype\" type=\"text\" id=\"studenttype\" onchange=\"checktype()\" ltype=\"text\" value=\"语言\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"major\"type=\"text\" id=\"major\" onchange=\"checkmajor()\" ltype=\"text\" value=\"\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"startdate\"type=\"text\" id=\"startdate\" class=\"date_picker link\" ltype=\"text\"  /></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">离校时间:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"enddate\"type=\"text\" id=\"enddate\" class=\"date_picker link\" ltype=\"text\" onchange=\"checkdate()\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"telephone\"type=\"text\" id=\"telephone\" ltype=\"text\" onchange=\"checkmobile()\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"validResidencePermit\"type=\"text\" onchange=\"checkval()\" class=\"date_picker link\" id=\"validResidencePermit\" ltype=\"text\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"roomplace\"type=\"text\" id=\"roomplace\" ltype=\"text\" onchange=\"checkroom()\" /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"source\"type=\"text\" id=\"source\" onchange=\"checksource()\" ltype=\"text\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"brithdate\"type=\"text\" id=\"brithdate\" onchange=\"checkbrith()\" class=\"date_picker link\" ltype=\"text\" /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\">\r\n");
      out.write("                   <select name=\"classid\" id=\"classid\" ltype=\"select\" style=\"width:140px;\" >\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"></td>\r\n");
      out.write("\t\t\t\t<th align=\"left\" colspan=\"2\"><input class=\"l-button l-button-submit\" type=\"submit\" value=\"添&nbsp;加\"/></th>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
  ...
  private boolean _jspx_meth_s_005fiterator_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/student/classstudentadd.jsp(592,6) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f0.setValue("#classlist");
    // /WEB-INF/student/classstudentadd.jsp(592,6) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/student/classstudentadd.jsp(593,7) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fif_005f0.setTest("#gg.id==#clsid");
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/student/classstudentadd.jsp(594,27) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/student/classstudentadd.jsp(594,57) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
