...
public final class classedit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("/system/Class_classupdate.action?cls.classname=\"+ encodeURI(encodeURI($(\"#classname\").val()))\r\n");
      out.write("\t\t        +\"&cls.id=\"+encodeURI(encodeURI($(\"#id\").val()))\r\n");
      out.write("\t\t        +\"&cls.classname_en=\"+encodeURI(encodeURI($(\"#classnameEN\").val()))\r\n");
      out.write("\t\t        +\"&cls.major=\"+encodeURI(encodeURI($(\"#major\").val())),null,function(){\r\n");
      out.write("\t\t        //alert('更新成功!');\r\n");
      out.write("\t\t        parent.m.hide();\r\n");
      out.write("\t\t        //parent.g.window.location.reload();\r\n");
      ...
      out.write("\t   $(\"#result\").html(\"班级名称不能为空!\");\r\n");
      out.write("\t   $(\"#result\").show();\r\n");
      out.write("\t    form.classname.focus();\r\n");
      out.write("\t    flg=false;\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t }else{\r\n");
      out.write("\t    if(!isNaN(classname)){\r\n");
      out.write("\t       $(\"#result\").html(\"班级名称不能全是数字!\");\r\n");
      out.write("\t       $(\"#result\").show();\r\n");
      out.write("\t      // form.classname.focus();\r\n");
      out.write("\t       flg=false;\r\n");
      out.write("\t\t   return false;\r\n");
      ...
      out.write("\t       $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Class_classcheckagain.action?cls.classname=\"\r\n");
      out.write("\t\t\t\t\t+ encodeURI(encodeURI($(\"#classname\").val()))+\"&cls.id=\"+$(\"#id\").val(), null, function(data) {\r\n");
      ...
      out.write("\t   if(major.length==0){\r\n");
      out.write("\t     $(\"#result1\").html(\"专业不能为空!\");\r\n");
      out.write("\t     $(\"#result1\").show();\r\n");
      out.write("\t     flg1=false;\r\n");
      out.write("\t     return false;\r\n");
      out.write("\t   }else{\r\n");
      out.write("\t      $(\"#result1\").hide();\r\n");
      out.write("\t      if(!reg.test(major)){\r\n");
      out.write("\t         $(\"#result1\").html(\"专业名称必须是中文!\");\r\n");
      out.write("\t         $(\"#result1\").show();\r\n");
      out.write("\t         // form.classname.focus();\r\n");
      out.write("\t         flg1=false;\r\n");
      out.write("\t\t     return false;\r\n");
      ...
      out.write("\t   var major = $(\"#classnameEN\").val();\r\n");
      out.write("\t   var reg= /^[a-zA-Z0-9]{2,}$/; \r\n");
      out.write("\t   if(major.length==0){\r\n");
      out.write("\t     $(\"#result2\").html(\"不能为空!\");\r\n");
      ...
      out.write("\t      $(\"#result1\").hide();\r\n");
      out.write("\t      if(!reg.test(major)){\r\n");
      out.write("\t         $(\"#result2\").html(\"英文名必须为两个及以上字符!\");\r\n");
      out.write("\t         $(\"#result2\").show();\r\n");
      out.write("\t         // form.classname.focus();\r\n");
      out.write("\t         flg2=false;\r\n");
      out.write("\t\t     return false;\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ classes.id}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\" type=\"hidden\" />\r\n");
      out.write("\t\t<table cellpadding=\"0\" cellspacing=\"0\" class=\"l-table-edit\">\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">班级名称:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"classname\" value=\"");
      ...
      out.write("\" type=\"text\"  id=\"classname\" onchange=\"check()\" ltype=\"text\" placeholder=\"请输入班级名称\"  /></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"classnameEN\"type=\"text\" id=\"classnameEN\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${classes.classname_en }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\" ltype=\"text\" onchange=\"check1()\"  /></td>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${classes.major }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\" id=\"major\" ltype=\"text\" onchange=\"checkmajor()\" /></td>\r\n");
