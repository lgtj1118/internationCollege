...
public final class scoreentry_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String  s= (String) request.getAttribute("classlist");
      ...
      out.write("\t\t\t\t\t\tvar h = \"\";\r\n");
      out.write("\t\t\t\t\t\th += \"<a style='color:#000;' href='javascript:courseclassscoreentry(\"+ \")'>录入成绩</a> \";\r\n");
      out.write("\t\t\t\t\t\treturn h;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t} ],\r\n");
      ...
      out.write("\t\t\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("    function courseclassscoreentry(){\r\n");
      ...
      out.write("/system/Manage_courseclassscoreadd.action?cls.id=\"+row.Classid+\"&semChosenCourse.semester=\"+semester+\"&course.num=\"+coursenum+\"&flag=\"+$(\"#flag\").val();\r\n");
