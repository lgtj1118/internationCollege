...
public final class longleave_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("/system/Manage_leaveadd.action?leave.passport=\" + $(\"#passport\").val() \r\n");
      ...
      out.write("\t\t\t\t\t\t\t+ \"&leave.telephone=\" + encodeURI(encodeURI($(\"#telephone\").val()))\r\n");
      out.write("\t\t\t\t\t\t\t+ \"&leave.type=\" + str\r\n");
      out.write("\t\t\t\t\t\t\t+ \"&leaveDoc=\" + $(\"#doc\").val() , \r\n");
      ...
      out.write("                  $(\"#result\").html(\"不足三天请用短期请假！\");\r\n");
      out.write("                 $(\"#result\").show();\r\n");
      out.write("                 flg = false;\r\n");
      out.write("                 return false;\r\n");
      out.write("             } else if (time1 > 22) {\r\n");
      out.write("                 $(\"#result\").html(\"长期请假最多不能超过22天！\");\r\n");
      out.write("                 $(\"#result\").show();\r\n");
      out.write("                 flg = false;\r\n");
      out.write("                 return false;\r\n");
      out.write("             } else{\r\n");
      ...
      out.write("                $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Manage_checkleave.action?leave.passport=\"+$(\"#stuid\").val()+\"&leave.leavingdate=\"+$(\"#startdate\").val()\r\n");
      out.write("                ,null,function(data){\r\n");
      out.write("                  if(data==\"fail\"){\r\n");
      out.write("                    $(\"#result\").html(\"你还有未销假或未审核的申请，不能再次申请！\");\r\n");
      out.write("                    $(\"#result\").show();\r\n");
      out.write("                    flg = false;\r\n");
      out.write("                    return false;\r\n");
      out.write("                  }else{\r\n");
      ...
      out.write("\r\n");
      out.write("\t<form name=\"form1\" method=\"post\" namespace=\"/system\" action=\"Manage_leaveadd.action\" enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t<input type=\"hidden\" value=\"2\" name=\"leave.type\"/>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input id=\"stuname\" disabled=\"disabled\" value=\"");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input id=\"nation\" disabled=\"disabled\" value=\"");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"leave.passport\"id=\"passport\" disabled=\"disabled\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${student.passport }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\"  /></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"leave.telephone\"id=\"telephone\" onchange=\"checkmobile()\" value=\"");
      ...
      out.write("\" onchange=\"checkmobile()\" /></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"docName\" class=\"filename\" readonly /> \r\n");
      out.write("\t\t\t\t\t\t<!--  <input accept=\"\" type=\"button\" class=\"button\" value=\"上传...\" />-->\r\n");
      out.write("\t\t\t\t\t    <input type=\"file\" name=\"leaveDoc\"  size=\"30\" />\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("                </td>\r\n");
      out.write("\t\t\t\t<td align=\"right\"></td>\r\n");
      out.write("\t\t\t</tr>\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">起始时间:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"leave.leavingdate\"  id=\"startdate\"   class=\"date_picker link\" onchange=\"check()\" ></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">截止时间:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"><input name=\"leave.backdate\"  id=\"enddate\" class=\"date_picker link\" onchange=\"check()\"  ></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td align=\"right\" class=\"l-table-edit-td\">请假事由:<font color=\"#ff0000\">*</font></td>\r\n");
      out.write("\t\t\t\t<th align=\"left\" class=\"l-table-edit-td\" colspan=\"5\"><textarea name=\"leave.leavereason\" id=\"reason\"  style=\"width: 400px;height: 200px;\"    ></textarea></th>\r\n");
      out.write("\t\t\t</tr>\t\t \r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t<td align=\"left\" class=\"l-table-edit-td\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\" ><input class=\"l-button l-button-submit\" type=\"submit\"  value=\"请&nbsp;&nbsp;假\"/></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\r\n");
      out.write("\t\t\t\t<td align=\"left\"></td>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
