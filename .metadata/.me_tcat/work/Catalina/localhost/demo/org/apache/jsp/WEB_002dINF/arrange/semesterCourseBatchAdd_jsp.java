...
public final class semesterCourseBatchAdd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\t\t<form name=\"form1\" id=\"form1\" method=\"post\" action=\"Manage_batchSetSemesterCourse.action\" namespace=\"/system\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("\t\t\t  \t请按照课程编号、教室类型、任课老师编号、上课班级编号的顺序组织文件，每个上课班级占一个单元格。\r\n");
      out.write("\t\t\t  \t");
      out.write("\r\n");
      out.write("\t\t\t  </td>\r\n");
      out.write("\t\t\t</tr>\r\n");
