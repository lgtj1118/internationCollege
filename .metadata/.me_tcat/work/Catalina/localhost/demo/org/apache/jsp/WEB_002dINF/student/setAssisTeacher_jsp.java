...
public final class setAssisTeacher_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String s = (String) request.getAttribute("classlist");
      ...
      out.write("\t\t\t}  */,{display : '外语', name : 'secondlanguagetype', minWidth : 80,  editor:{type:'text'}\t\t\t\t\r\n");
      ...
      out.write("            } ,{display : '邮箱', name : 'email', width : 200,  editor:{type:'text'}\t}           \r\n");
      ...
      out.write("\t  \tvar assistantnum =  row.assistantnum;\r\n");
      out.write("\t  \tif (assistantnum == \"\"){\r\n");
      out.write("\t  \t\talert(\"请选择助教！\");\r\n");
      out.write("\t  \t\treturn;\r\n");
      out.write("\t  \t}\r\n");
      out.write("\t \tvar url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Class_AssishowMany.action?queryID=\" + assistantnum;\r\n");
      ...
      out.write("\t\t        \t\tvar msg = \"该助教已经是\";\t\r\n");
      out.write("\t\t        \t\tfor(var n=0;n<data.length;n++){\r\n");
      out.write("\t\t        \t\t\tmsg = msg + data[n].classname + \" \";\t\r\n");
      out.write("\t\t          \t\t}; \r\n");
      out.write("\t\t          \t\tmsg = msg + \"的助教了，是否继续？\";\r\n");
      out.write("\t\t          \t\ttips(msg, assistantnum);\r\n");
      out.write("\t\t          \t\treturn;\t\r\n");
      out.write("\t\t        \t} else {\r\n");
      out.write("\t\t        \t\tprint(assistantnum);\r\n");
      out.write("\t\t        \t};\r\n");
      out.write("\t\t        }  \r\n");
      out.write("\t\t    }); \r\n");
      out.write("\t }\r\n");
      ...
      out.write("\t }\r\n");
      out.write("\t\r\n");
      out.write("\tfunction print(num){\r\n");
      out.write("\t  var url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Class_setAssisTeacher.action?assistantteacher.id=\"+num;\r\n");
      ...
      out.write("\t\t  url:\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Class_assisTeacherFuzzy.action?fuzzyText=\" + encodeURI(encodeURI(t)),\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t<!--  <a class=\"l-button\" style=\"width:70px;float:left; margin:3px;\" onclick=\"confirm()\">选&nbsp;&nbsp;择</a> -->       \r\n");
      ...
      out.write("\t \t\t<td><input type=\"text\" id=\"keyword\" onkeyup=\"fuzzy()\" style=\"font-size:12px; width:180px;\" placeholder=\"姓名 学号 外语  政治面貌 专业\"></td>\r\n");
      out.write("\t \t\t<td width=\"30px\"></td>\r\n");
      out.write("\t \t\t<td><a class=\"l-button\" style=\"width:150px;font-size:12px;float:left; margin:3px;\" onclick=\"confirm()\">设置为助理班主任</a></td>\r\n");
      out.write("\t \t\t<td></td>\r\n");
      out.write("\t \t</tr>\r\n");
      out.write("\t </table>\r\n");
