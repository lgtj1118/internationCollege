...
public final class courseattendenceclass_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String  s= (String) request.getAttribute("classlist");
      ...
      out.write("\t\t\t\t\t\tvar h = \"\";\r\n");
      out.write("\t\t\t\t\t\th += \"<a style='color:#000;' href='javascript:attendencestu(\"+ \")'>查看统计</a> \";\r\n");
      out.write("\t\t\t\t\t\treturn h;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t} ],\r\n");
      ...
      out.write("/system/Manage_courseclassstustatistical.action?cls.id=\"+row.Classid+\"&course.num=\"+$(\"#courseid\").val()+\"&course.coursename=\"+$(\"#coursename\").val();\r\n");
