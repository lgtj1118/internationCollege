...
public final class graduateaudit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String  s= (String) request.getAttribute("classlist");
      ...
      out.write("\t\t\t\t\t\tvar h = \"\";\r\n");
      out.write("\t\t\t\t\t\th += \"<a style='color:#000;' href='javascript:classstu(\"+ \")'>毕业审核</a> \";\r\n");
      out.write("\t\t\t\t\t\treturn h;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t} ],\r\n");
      ...
      out.write("\t \t  alert(\"该班级已毕业,无需审核！\");\r\n");
      out.write("\t \t}else if(row.type==1){\r\n");
      out.write("\t \t  alert(\"该班级已删除，不能审核！\");\r\n");
      out.write("\t \t}else{\r\n");
      out.write("\t \t  var str = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Class_graduateclassstulist.action?cls.id=\"+row.id;\r\n");
      out.write("          top.f_addTab('graduateclassstu','毕业班级学生审核',str);\r\n");
      out.write("\t \t}   \r\n");
      out.write("}\t\r\n");
      ...
      out.write("        alert(\"该班级已毕业，无需审核！\");\r\n");
      out.write("      }else if(row.type==1) {\r\n");
      out.write("        alert(\"该班级处于删除状态，不能审核！\");\r\n");
      out.write("      }else{\r\n");
      out.write("        $.ligerDialog.confirm('如班级学生存在未审核通过，该班级将不被审核？', function (yes){\r\n");
      out.write("       if(yes){\t\r\n");
      out.write("\t     $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/system/Class_graduateclass.action?cls.id=\"+ row.id,null,function(){\r\n");
      ...
      out.write("\t    <a class=\"l-button\" style=\"width:60px;float:left; margin:3px;\" onclick=\"addclass()\">班级审核</a>\t\t\t\r\n");
