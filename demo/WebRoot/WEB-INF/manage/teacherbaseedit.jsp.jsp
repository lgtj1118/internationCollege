	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="usernum" value="${teachers.identificationnum }" type="text"  id="usernum" disabled="disabled" ltype="text" placeholder="请输入用户编号"  /></td>
				<td align="left"></td>
			</tr>			
			<tr>
				<td align="right" class="l-table-edit-td">姓名:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="realname"type="text" onchange="checkname()" value="${teachers.teachername }" id="realname" ltype="text" /></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="telephone" style="width: 170px;" value="${teachers.telephone }" onblur="checkmobile()" type="text" id="telephone" ltype="text" /></td>
				...
				<td align="left" class="l-table-edit-td">
				  <s:iterator value="#deptlist" id="gg">
						  <s:if test="#gg.deptid==#teachers.dept.deptid">
				              <input id="deptid" name="deptid" value="${gg.deptid }" type="hidden"/>
				              <input id="deptname" name="deptname" value="${gg.deptname }" disabled="disabled" style="width: 170px;" />
				          </s:if>						
				</s:iterator>
				<%-- <select name="depid" id="depid" ltype="select">
						<s:iterator value="#deptlist" id="gg">
						  <s:if test="#gg.deptid==#teachers.deptid">
