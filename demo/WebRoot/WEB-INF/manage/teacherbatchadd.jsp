...
<script type="text/javascript">
	/* var eee;
        $(function () {
			...
			submitHandler : function() {
				...
				if(flg){			
				$.post("${pageContext.request.contextPath}/system/Stu_teacheraddbytxt.action"
		        ,null,function(){
		       });
			 }	
			 }		
	...
	function check() {	    		
	  ...
	  if(mime!=".xls"){
	    $("#result").html("请选择Excel文件 xls 格式 上传！");
	    $("#result").show();
	    flg = false;
	  }else{
	    $("#result").hide();
...
<body style="padding: 10px">
	<!-- <form name="form1" id="form1" method="post" action="Manage_teacheraddbytxt.action" namespace="/system" enctype="multipart/form-data"> -->
	<form name="form1" id="form1" method="post" action="Manage_jmpBatchResult.action" namespace="/system" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="left" class="l-table-edit-td" width="90px">选择Excel文件:</td>
				<td align="left" class="l-table-edit-td">
				<div class="uploader white">
						<input type="text" class="filename" readonly /> 
						<input accept="" type="button" class="button" value="上传..." />
					    <input type="file"name="file" onblur="check()" size="30" />
					</div></td>
				<td align="right"></td>
			</tr>
			<tr>
