	...
	function check2(){
	  ...
	  if(username.length==0){
	     ...
	     if(!reg.test(username)){
	         $("#result2").html("真实姓名只能是包含两个字符以上中文!");
		     $("#result2").show();
		     flg1 = false; //就弹出提示信息    
	     }else{
	         $("#result2").hide();
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="usernum" disabled="disabled" type="text" value="${users.usernum }" id="usernum" onchange="check()" ltype="text" placeholder="请输入用户编号" /></td>
