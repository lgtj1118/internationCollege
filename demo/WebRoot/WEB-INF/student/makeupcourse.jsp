...
$(document).ready(function(){			
	...
	function f_initGrid() {
		g = manager = $("#maingrid").ligerGrid(
				...
				editor: { type: 'text'}
					...
					render : function() {
						var h = "";
						h += "<a style='color:#000;' href='javascript:entryscore("+ ")'>录入补考成绩</a> ";
						return h;
					}
			} ],
    ...
    function entryscore(){
      ...
      if(semester.length==0){
        ...
        var flag = 1;//补考
        var str = "${pageContext.request.contextPath}/system/Manage_makeupscoreentry.action?course.num="+row.num+"&course.coursename="+row.coursename+"&semChosenCourse.semester="+semester+"&flag="+flag;		  
	    var tabid = "courseclasslist";
        top.f_addTab(tabid,row.coursename+"补考成绩录入",str);
      }    
    }
    function f_search(){
      var semester = $("#semester option:selected").val();
