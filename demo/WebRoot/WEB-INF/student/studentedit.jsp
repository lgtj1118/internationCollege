   ...
   if(firstname.length==0){
     ...
     if(lastname.length==0){
        ...
        if(!reg.test(firstname)||!reg.test(lastname)){
          $("#result12").html("英文名或英文姓为（2—80）个字符！");
          $("#result12").show();
          flgt=false;
        }else{
        //$("#result12").hide();
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">			
			...
			<td align="right" class="l-table-edit-td">护照号:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="passport"type="text"  onchange="checkpassport()" value="${student.passport }" id="passport" ltype="text" placeholder="请输入护照号"  /></td>
				<td align="left"><div id="result2" style="color: red;"></div></td>
				<td align="right" class="l-table-edit-td">学号:</td>
				<td align="left" class="l-table-edit-td"><input name="stunum"type="text" id="stunum"  onchange="checknum()" value="${student.stuid }" ltype="text" /></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="studenttype" value="${student.studentType }" onchange="checktype()" type="text" id="studenttype" ltype="text" /></td>
				<td align="left"><div id="result4" style="color: red;"></div></td>
				<td align="right" class="l-table-edit-td">专业:</td>
				<td align="left" class="l-table-edit-td"><input name="major"type="text" id="major" onchange="checkmajor()" value="${student.classes.major }"  ltype="text" /></td>
				<td align="left"><div id="result5" style="color: red;"></div></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">入学时间:</td>
				<td align="left" class="l-table-edit-td"><input name="startdate"type="text"  value="${student.startdate }" id="startdate" v ltype="text" class="date_picker link" /></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td">离校时间:</td>
				<td align="left" class="l-table-edit-td"><input name="enddate"type="text" onchange="checkdate()" id="enddate" value="${student.enddate }" ltype="text" class="date_picker link" /></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="validResidencePermit"type="text" onchange="checkval()" id="validResidencePermit" value="${student.validResidencePermit }" ltype="text" class="date_picker link" /></td>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="source"type="text" id="source" onchange="checksource()" value="${student.source }" ltype="text" /></td>
