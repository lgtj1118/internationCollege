...
<script type="text/javascript">
	...
	function check2() {
		...
		$("#result2").hide();
		$.post("${pageContext.request.contextPath}/system/Class_roomcheckagain.action?room.roomname="
						+ $("#roomname").val(), null, function(data) {
					if (data == "fail") {
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="num"type="text" disabled="disabled" value="${classroom.num }" disabled="disabled" id="num" ltype="text" onchange="check()" placeholder="请输入编号"  /></td>
				<td align="left"><div id="result" style="color: red;"></div></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">教室名:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="roomname"type="text" id="roomname" disabled="disabled" value="${classroom.roomname }" onchange="check2()" ltype="text"/></td>
			...
			<tr>
				...
				<input name="roomplace"type="text" id="roomplace" ltype="text" value="${classroom.roomplace }" disabled="disabled" onchange="check3()"  /></td>
