	...
	/* var eee;
        $(function () {
			...
			submitHandler : function() {
				...
				if(flg){			
				$.post("${pageContext.request.contextPath}/system/Stu_stuaddbytxt.action"
		        ,null,function(){		   
		       });
			 }	
			 }		
...
<style type="text/css">
  body {font-size: 14px;}
 .l-table-edit{width:80%;margin-left:0px;}
...
<body style="padding: 10px">
	<form name="form1" id="form1" method="post" action="Stu_classstuaddbytxt.action" namespace="/system" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
			    <input id="classid" name="cls.id" value="${classids }" type="hidden" />
			...
			<tr>
			  <td align="left" class="l-table-edit-td" style="width:80px;" >文件格式:</td>
			  <th colspan="2">
			    <table style="font-size: 10px;width:100%;" >
			       <tr>
			           <td>学号</td> <td>英文名</td> <td>英文姓</td> <td>中文名</td> <td>性别</td> <td>电话</td> <td>住址</td> <td>国籍</td> <td>学生类别</td> <td>护照号</td> <td>入学时间</td> <td>离校时间</td> <td>来源</td>
			       </tr>
			       <tr>
			           <td>1111110</td> <td>San</td> <td>Zhang</td> <td>张三</td> <td>男</td> <td>13500000000</td> <td>国际教育学院</td> <td>中国</td> <td>语言</td> <td>123456</td> <td>2015-05-05</td> <td>2018-05-05</td> <td>个人</td>
			       </tr>
			    </table>
			  </td>
			</tr>
