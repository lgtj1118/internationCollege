	    ...
	    if(!isNaN(classname)){
	      ...
	      // form.classname.focus();
	       ...
	       $.post("${pageContext.request.contextPath}/system/Class_classcheck.action?cls.classname="
					+ encodeURI(encodeURI($("#classname").val())), null, function(data) {
					if (data == "fail") {
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="classname"type="text" onchange="check()" id="classname" ltype="text" placeholder="请输入班级名称" /></td>
				<td align="left"><div id="result" style="color: red;"></div></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">英文名称:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="classnameEN"type="text" id="classnameEN" ltype="text" onchange="check1()"  /></td>
				<td align="left"><div id="result2" style="color: red;"></div></td>
			</tr>									 			
			<tr>
				<td align="right" class="l-table-edit-td">专业:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="major"type="text" id="major" ltype="text" onchange="checkmajor()"  /></td>
