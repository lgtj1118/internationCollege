...
<body style="padding: 10px">
	<!-- <form name="form1" id="form1" method="post" action="Class_classaddbytxt.action" namespace="/system" enctype="multipart/form-data"> -->
		<form name="form1" id="form1" method="post" action="Class_jmpBatchAddCourses.action" namespace="/system" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="left" class="l-table-edit-td" width="100px">选择Excel文件:</td>
			...
			<tr>
			  ...
			  <td colspan="2">
			  	请按照课程名、课程英文名、起始周、结束周、学分、周学时、课程性质、开课学院的顺序组织文件。
			  </td>
			</tr>
			<tr>
