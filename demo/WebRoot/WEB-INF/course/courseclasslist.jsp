...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    var str = "${pageContext.request.contextPath}/system/Manage_courseclassstulist.action?cls.id="+row.Classid+"&course.num="+$("#courseid").val()+"&course.coursename="+$("#coursename").val();
		m=$.ligerDialog.open({
			url : str,
			height : 650,
			width : 1000,
