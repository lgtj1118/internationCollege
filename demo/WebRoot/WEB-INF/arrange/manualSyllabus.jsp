...
<script type="text/javascript">
   ...
   function changecourse(coursenum){
     if(coursenum!=null){
        var str = "${pageContext.request.contextPath}/system/Manage_removeSyllabus.action?insertID="+coursenum;
...
<body style="padding: 2px; " >
	<dir style="float: left; padding-left:10px">
		<table>
			<tr>
				<td><font size="5">手动置入课程</td>
				<td height="25px">
				<a class="l-button" style="width:60px;float:left; margin-left:10px"  href="system/Manage_saveManualSyllabus.action">保存</a>
			 </td>
			</tr>
			<tr>
			  	<td></td>
