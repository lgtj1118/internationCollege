	...
	$(function(){
		...
		var v = $("form")
			.validate({
				...
				if (flg&&flg7) {
							var str = 1;
							$.post("${pageContext.request.contextPath}/system/Manage_leaveupdate.action?leave.passport=" + $("#passport").val() 
							+ "&leave.id=" + encodeURI(encodeURI($("#id").val())) 
							...
							+ "&leave.telephone=" + encodeURI(encodeURI($("#telephone").val())) + "&leave.type=" + str, 
							null, function(){
									//alert('提交成功!');
									parent.m.hide();
...
<body style="padding: 10px">
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<div><input id="stuid" value="${student.stuid }" type="hidden"/>
		<input id="id" value="${leaves.id }" type="hidden"/></div>
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"><input name="telephone"id="telephone" onchange="checkmobile" value="${leaves.telephone }" /></td>
				<td align="left" colspan="4" ><div id="result7" style="color: red;" ></div></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">请假起始时间:</td>
				<td align="left" class="l-table-edit-td"><input  id="startdate"   class="date_picker link" value="${leaves.leavingdate }" onchange="check()" ></td>
				<td align="left"></td>
				<td align="right" class="l-table-edit-td">请假截止时间:</td>
				<td align="left" class="l-table-edit-td"><input  id="enddate" class="date_picker link" value="${leaves.backdate }"  onchange="check()"  ></td>
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">请假事由:</td>
				<th align="left" class="l-table-edit-td" colspan="5"><textarea id="reason"  style="width: 400px;height: 200px;"    >${leaves.leavereason }</textarea></th>
			</tr>		 
			<tr>
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"></td>
				<td align="left"></td>
				<td align="left" ><input class="l-button l-button-submit" type="submit"  value="更&nbsp;&nbsp;新"/></td>
				<td align="left"></td>
				<td align="left"></td>							
			</tr>
		</table>
