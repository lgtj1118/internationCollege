...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function f_initGrid() {
		g = manager = $("#maingrid").ligerGrid(
				...
				editor: { type: 'text'}
					...
					render : function() {
						var h = "";
						h += "<a style='color:#000;' href='javascript:attendencestu("+ ")'>查看统计</a> ";
						return h;
					}
			} ],
    ...
    var str = "${pageContext.request.contextPath}/system/Manage_courseclassstustatistical.action?cls.id="+row.Classid+"&course.num="+$("#courseid").val()+"&course.coursename="+$("#coursename").val();
	...
	<body style="padding: 2px">
		<br/><input id="courseid" value="${course.num }" type="hidden" />
