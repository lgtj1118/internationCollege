...
<body style="padding: 10px">
	<form name="form1" id="form1" method="post" action="Stu_jmpStuBatch.action" namespace="/system" enctype="multipart/form-data">
	<!-- <form name="form1" id="form1" method="post" action="Stu_stuaddbytxt.action" namespace="/system" enctype="multipart/form-data"> -->
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="left" class="l-table-edit-td" width="80px">选择Excel文件:</td>
