	...
	<form name="form1" id="form1" method="post" action="Class_roomaddbytxt.action" namespace="/system" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
			  ...
			  <th colspan="4" width="150px;">
			     <table width="100%" >
			          <tr>
			             <td>教室名称</td><td>教室位置</td><td>教室类型</td><td>容量</td><td>实际容量</td>
			          </tr>
			          <tr>
			             <td>test</td><td>国际教育学院</td><td>多媒体教室</td><td>120</td><td>120</td>
			          </tr>
			     </table>
			  </th>
			</tr>
