...
/* 	var eee;
        $(function () {
			...
			submitHandler : function() {
				...
				if(flg){			
				$.post("${pageContext.request.contextPath}/system/Class_classaddbytxt.action"
		        ,null,function(){		   
		       });
			 }	
			 }		
...
<body style="padding: 10px">
	<!-- <form name="form1" id="form1" method="post" action="Class_classaddbytxt.action" namespace="/system" enctype="multipart/form-data"> -->
		<form name="form1" id="form1" method="post" action="Class_jmpBatchSetUp.action" namespace="/system" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="right" class="l-table-edit-td" width="100px">选择Excel文件:</td>
			...
			<tr>
			  ...
			  <td colspan="2">
			  	请按照班级名称、班级英文名称、专业的顺序组织文件。
			  	<%-- <img src="<%=basePath%>images/addtxt/classbatch.png" alt="" style="width: 500px;height: 80px" /> --%>
			  </td>
			</tr>
			<tr>
			...
			<tr>
				<th style="text-align:center;" colspan="3"><br> <input type="submit" onclick="check()" value="添&nbsp;加" class="l-button l-button-submit" />
				</td></th>
			</tr>
