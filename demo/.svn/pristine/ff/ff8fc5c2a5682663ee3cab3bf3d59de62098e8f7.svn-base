...
<script type="text/javascript">  
	...
	function f_initGrid() {
		g = manager = $("#maingrid").ligerGrid(
				...
				display : '课程名称(CourseName)',
				name : 'coursename',
				minWidth : 120,
				editor: { type: 'text'}
			}, {
				display : '护照号(Passport)',
				name : 'passport',
				width : 120,
				editor: { type: 'text'}
			}, {
				display : '姓名(Chinename)',
				name : 'stuname',
				width : 120,
				editor: { type: 'text'}
			}, {
...
.l-button{
 ...
 border-radiux:5px;
	...
	<body style="padding: 2px">	
	               ...
	               <td>
	                   ...
	                   <td><select id="coursenum" class="link" >
	                      ...
	                      <s:iterator value="#courselist" id="c" >
	                         <option value="${c.num }" >${c.coursename }(&nbsp;${c.coursename_en } )</option>
	                      </s:iterator>
	                   </select></td>
	            </tr>
	         </table>
		...
		<div id="maingrid" ></div>
		<div style="margin:10px;" > 备注：&nbsp;&nbsp;出勤：Attendance； 作业：Homework； 期中：Middle Examination； 期末：Final Examination；综合：Total Score；</div>
	</body>
</html>
