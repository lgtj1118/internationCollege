  ...
  function f_search(){
     ...
     if(stuid.length==0){
        alert("请输入查询护照号！");
         ...
         $("span").empty();
         $(".tabletr").empty();
         $.post("${pageContext.request.contextPath}/system/Manage_transcriptsearch.action?semChosenCourse.semester="+semester+"&stu.passport="+stuid
         ,null,function(data){
            if(data=="#"){
                alert("没有查到相关成绩！");
            }else{
                ...
                for(var i=0;i<obj.length;i++){ 
                   ...
                   newcell9.innerHTML = obj[i].summary;  
                } 
               document.getElementById("nowdate").innerHTML=nowdate;
               document.getElementById("endate").innerHTML=endate;
           }
  ...
  <body>
    <div id="head">
	      ...
	      <div class="search" >
			...
			<tr>
			   <td align="right" class="l-table-edit-td">&nbsp;&nbsp;&nbsp;开课学期: <br></td>
				<td align="left" class="l-table-edit-td">
				   <select id="semester" name="semester" class="link" >
				     <option></option>
				   </select>
				</td>
				<td align="right" class="l-table-edit-td">&nbsp;&nbsp;学生护照号:<font color="#ff0000">*</font> <br></td>
				<td align="left" class="l-table-edit-td">
	...
	<div style="width:80%;margin-right: 50px;margin-top:10px;"align="right" >编号No：</div>
	   <table id="table1" border="1" cellpadding="0" cellspacing="0" align="center" >
	     <tr>
	   ...
	   <div id="score" ><br><br>
	     <table id="table2" border="1" cellpadding="0" cellspacing="0" align="center" >
	   <tr >
