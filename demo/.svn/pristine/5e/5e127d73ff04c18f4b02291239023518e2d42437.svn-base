...
<script type="text/javascript">
   ...
   function changecourse(coursenum){
     if(coursenum!=null){
        var str = "${pageContext.request.contextPath}/system/Manage_adjustList.action?num="+coursenum;
...
<body style="padding: 2px; ">
	<dir style="float: left; padding-left:10px">
		<table>
			<tr>
				<td><font size="5"><strong>注</strong>
				</font>：点击需要调换的课程</td>
	...
	<div>
		<table class="gridtable" align="center">
			...
			<tr>
				...
				<td align="center" style="color:red"><a
					onclick="changecourse(<%=course.getNum()%>)"> <pre
