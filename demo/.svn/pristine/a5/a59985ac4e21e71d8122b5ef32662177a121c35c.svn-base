...
public class StudentModel   {
	...
	private Integer id;
     ...
     private String standardcredits;
	...
	public String getStandardcredits() {
		return standardcredits;
	}
	public void setStandardcredits(String standardcredits) {
		this.standardcredits = standardcredits;
	}
