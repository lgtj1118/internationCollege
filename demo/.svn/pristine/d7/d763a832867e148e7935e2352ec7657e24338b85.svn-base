	...
	var eee;
        $(function () {
			...
			submitHandler : function() {
                ...
                var url = "${pageContext.request.contextPath}/system/Stu_stuendadd.action?stu.stuid="+ $("#stunum").val()
		        ...
		        +"&stu.source="+ encodeURI(encodeURI($("#source").val()))
		        +"&stu.studyLevel=" + encodeURI(encodeURI($("#studyLevel").val()));
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit" align="center" >
			...
			<td align="right" class="l-table-edit-td">班级:</td>
				<td align="left" class="l-table-edit-td">
                   <select name="classid" id="classid" ltype="select"  class="link" style="width:140px;" >
			    ...
			    <td align="right" class="l-table-edit-td">学习层次:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td">
					<select id="studyLevel" class="link">
						<option value="二年制本科">二年制本科</option>
						<option value="四年制本科">四年制本科</option>
						<option value="长期进修">长期进修</option>
						<option value="短期进修">短期进修</option>
						<option value="三年制硕士">三年制硕士</option>
					</select>
				</td>
				<td align="left"></td>
			</tr>				 
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td"></td>
				<th align="left" colspan="2" style="height:50px;" ><input class="l-button l-button-submit" type="submit" value="添&nbsp;加"/></th>
				<td align="left" class="l-table-edit-td"></td>
				<td align="left"></td>							
			</tr>
		</table>
