        ...
        $(function () {
			...
			submitHandler : function() {
                ...
                if(secondlanguagetype.length!=0&&secondlanguagelevel.length!=0){
                   //  if(flg&&flg1&&flg2){
                  $.post("${pageContext.request.contextPath}/system/Class_assistantteacherupdate.action?assistantteacher.classname="+ encodeURI(encodeURI($("#classname").val()))
		        +"&assistantteacher.id="+encodeURI(encodeURI($("#id").val()))
...
<body style="padding: 10px">
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<input id="id" value="${assist.id }" type="hidden"  />
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="right" class="l-table-edit-td">姓名:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="name"type="text" onchange="checkname()" id="name" ltype="text" value="${assist.name }" placeholder="请输入姓名"  /></td>
				...
				<td align="left" class="l-table-edit-td"><input name="nation"type="text" onchange="checknation()" id="nation" ltype="text" value="${assist.nation }" placeholder="请输入民族" /></td>				
				<td align="left"></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">学号:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="assistnum"type="text" onchange="checknum()" style="width: 175px;" id="assistnum" value="${assist.assistantnum }" placeholder="请输入学号" ltype="text" /></td>
				<td align="right" ><div id="result7" style="color: red;"></div></td>
				<td align="right" class="l-table-edit-td">班级:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="classname"type="text" value="${assist.classname }"  id="classname" onchange="checkclass()" style="width: 175px;"  ltype="text" placeholder="请输入班级名称"  /></td>				
				<td align="left"><div id="result8" style="color: red;"></div></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">联系方式:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="telephone"type="text" id="telephone"  value="${assist.telephone }" ltype="text" placeholder="手机号码"  onchange="checkmobile()"  /></td>
				<td align="right" ><div id="result1" style="color: red;"></div></td>
				<td align="right" class="l-table-edit-td">邮箱:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="email"type="text"  id="email" value="${assist.email }" ltype="text" placeholder="邮箱" onchange="checkemail()"  /></td>				
				<td align="left"><div id="result2" style="color: red;"></div></td>
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">出生年月:</td>
				<td align="left" class="l-table-edit-td"><input name="brithdate"type="text" onchange="checkbrith()" value="${assist.brithdate }" id="brithdate" ltype="text" placeholder="格式：1900-00-00" class="date_picker link"  /></td>
				<td align="right" ><div id="result6" style="color: red;"></div></td>
				<td align="right" class="l-table-edit-td">性别:</td>
				<s:if test="#assist.gender=='男'.toString()">
				...
				<s:elseif test="#assist.gender=='女'.toString()">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				  <s:if test="#assist.politicalstatus=='党员'.toString()">
				  ...
				  <s:elseif test="#assist.politicalstatus=='团员'.toString()">
				     <select id="politicalstatus" style="width: 180px;" name="politicalstatus"  ltype="select">
			...
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				 <select type="select" id="department"  style="width: 180px;"  >
				   <option value="${assist.department } " selected="selected" >${assist.department } </option>
				...
				<td align="left" class="l-table-edit-td"><input name="major"type="text" value="${assist.major }" onchange="checkmajor()" style="width: 175px;" id="major" ltype="text"/></td>
			...
			<tr>
				...
				<!-- <input name="secondlanguagetype"type="text" id="secondlanguagetype" ltype="text"validate="{required:true,minlength:1,maxlength:20}" type="hidden" /> -->
				 <select id="secondlanguagetype" onchange="changeselect()" style="width: 180px;" onblur="check()" >
				    <s:if test="#assist.secondlanguagetype=='英语'.toString()">
				       <option value="英语" selected="selected" >英语</option>
				       <option value="日语" >日语</option>
				    </s:if> 
				    <s:elseif test="#assist.secondlanguagetype=='日语'.toString()">
				...
				<select  id="secondlanguagelevel" style="width: 180px;" onblur="check()" >
				   <option value="${assist.secondlanguagelevel }" >${assist.secondlanguagelevel }</option>
				</select>				
				</td>				
				<td align="left"></td>
			</tr>
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				   <input name="responsiblename" style="width: 175px;" id="responsiblename" onchange="checkresponsiblename()" type="text"value="${assist.responsiblename}" />
				</td>
				<td align="right" ><div id="result9" style="color: red;"></div></td>
				<td align="right" class="l-table-edit-td">负责人电话:</td>
				<td align="left" class="l-table-edit-td">
				   <input name="responsibletelephone"type="text" style="width: 175px;" onchange="checkresponsiblemobile()" value="${assist.responsibletelephone }"  id="responsibletelephone"  />				
				</td>				
				<td align="left"><div id="result10" style="color: red;"></div></td>
			</tr>
			<tr>
				<th align="right" class="l-table-edit-td">特长:</td>
				<th align="left" class="l-table-edit-td" colspan="4"><textarea id="forte" style="width: 450px;height: 150px;">${assist.forte }</textarea></th>				
				<td align="left"></td>
			</tr>			 			
			<tr>
			...
			<tr>
				<td align="right" class="l-table-edit-td"></td>
				<td align="right" class="l-table-edit-td"></td>
				<td align="center" class="l-table-edit-td" style="text-align: center;" ><br /><input type="submit" value="更&nbsp;&nbsp;新" id="Button1" class="l-button l-button-submit" /> </td>
				<td align="right" class="l-table-edit-td"></td>
				<td align="left">&nbsp;
			</tr>
		</table>
