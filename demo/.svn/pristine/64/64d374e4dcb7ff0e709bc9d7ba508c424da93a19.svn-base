	...
	var eee;
        $(function () {
			...
			submitHandler : function() {
				...
				var url = "${pageContext.request.contextPath}/system/Class_workrecordupdate.action?classrecord.classid="+ encodeURI(encodeURI($("#classid").val()))
		        +"&classrecord.id="+encodeURI(encodeURI($("#id").val()))
...
<form name="form1" method="post" action="" id="form1">
		...
		<input id="id" value="${work.id}" type="hidden" />
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				...
				<td align="left" class="l-table-edit-td">
				  <select id="classid" type="select" onchange="check(),checkclass()"  >
				   <s:iterator value="#teacherclass" id="c" >
				     <s:if test="#c.id==#work.classid">
				      <option value="${c.id }" selected="selected" ><s:property value="#c.classname"  /></option>
				     </s:if>
				     <s:else>
				        <option value="${c.id }" ><s:property value="#c.classname"/></option>
				     </s:else>
				   </s:iterator>
				</select>
				</td>
				...
				<td valign="top"><br /></td><td align="left" class="l-table-edit-td"><input name="classmonitor"type="text"  id="classmonitor"  ltype="text" value="${stu.stuname }"  /></td>			
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td">本月班会次数:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><input name="classmeetingfrequency" onchange="check1()" type="text" value="${work.classmeetingfrequency }" id="classmeetingfrequency" ltype="text"   /></td>
				...
				<td align="left" class="l-table-edit-td"><input name="appointmentnumber"type="text" onchange="checknum();" value="${work.appointmentnumber }" id="appointmentnumber" ltype="text"  /></td>
				<td align="right" class="l-table-edit-td"></td>
				<td align="right" class="l-table-edit-td">自我工作评价:</td>
				<td valign="top"><div id="result1" style="color: red;" ></div></td>
				<td align="left" class="l-table-edit-td">
				 <select id="selfevalution" >
				   <s:if test="#work.selfevalution==0">
				      <option value="0" selected="selected" >优秀</option>
				      <option value="1" >良</option>
				      <option value="2" >中等</option>
				      <option value="3" >不好</option>
				   </s:if>
				   <s:elseif test="#work.selfevalution==1">
				      <option value="1" selected="selected" >良</option>
				      <option value="0"  >优秀</option>				      
				      <option value="2" >中等</option>
				      <option value="3" >不好</option>
				   </s:elseif> 
				   <s:elseif test="#work.selfevalution==2">
				      <option value="2" selected="selected" >中等</option>
				      <option value="0"  >优秀</option>	
				      <option value="1" >良</option>			      				      
				      <option value="3" >不好</option>
				   </s:elseif> 
				   <s:elseif test="#work.selfevalution==3">
				      <option value="3" selected="selected"  >不好</option>
				      <option value="0"  >优秀</option>	
				      <option value="1" >良</option>		
				      <option value="2" >中等</option>	      				      
			...
			<tr>
			  ...
			  <th colspan="6"><textarea id="physicalmentalcondition" onchange="checksis()"   >${work.physicalmentalcondition }</textarea></th>
			</tr>
			<tr>
			  <td>学生上课情况：<font color="#ff0000">*</font></td>
			  <th colspan="6"><textarea id="studyingcondition" onchange="checksis()" >${work.studyingcondition }</textarea></th>
			</tr>
			<tr>
			  <td>学生反映的课程、老师、学院问题：</td>
			  <th colspan="6"><textarea id="feedback" >${work.feedback }</textarea></th>
			</tr>
