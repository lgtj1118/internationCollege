...
<script type="text/javascript">
	var eee;
        $(function () {
			...
			submitHandler : function() {
				...
				check1();
				if(flg&&flg1){
				$.post("${pageContext.request.contextPath}/system/Class_performanceendadd.action?performance.passport="+ encodeURI(encodeURI($("#stuid option:selected").val()))
     ...
     if(stuname.length==0){
	   ...
	   $("#result").show();	
        ...
        /* $.post("${pageContext.request.contextPath}/system/Stu_stucheckname.action?stu.stuname="
					+ encodeURI(encodeURI($("#stuid").val())), null, function(data) {
					if (data == "fail") {
	...
	function check1(){
	   ...
	   if(event.length==0||dailylife.length==0||outstanding.length==0||psychicology.length==0){
	        ...
	        success : function(data) {
	        	...
	        	if (data.length > 0){
	        		...
	        		for(var n=0;n<data.length;n++){
	        		   document.getElementById("stuid").options.add(new Option(data[n].stuname,data[n].passport));
	          		} 
	        	} else {
	        	}
	        }  
...
<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="right" >班级:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td">
				   <select id="classid" onchange="checkstu()" >
			        <option value="" ></option>
				...
				<td align="right" >姓名:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td">
				 <select id="stuid" name="stuid" type="select" style="width:120px;" onchange="check()" ></select>				
				</td>							
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td" >学习方面:<font color="#ff0000">*</font></td>
				<td align="left" class="l-table-edit-td"><textarea id="study" onchange="check1()" ></textarea> </td>			
			    <td class="l-table-edit-td">生活方面：<font color="#ff0000">*</font></td>
			    <td class="l-table-edit-td"><textarea id="dailylife" onchange="check1()" ></textarea></td>
			</tr>
			<tr>
			   <td class="l-table-edit-td">活动能力：<font color="#ff0000">*</font></td>
			   <td class="l-table-edit-td"><textarea id="event" onchange="check1()" ></textarea></td>
			   <td class="l-table-edit-td">突出表现：<font color="#ff0000">*</font></td>
			  <td class="l-table-edit-td"><textarea id="outstanding" onchange="check1()"  ></textarea></td>
			</tr>
			<tr>
			  <td class="l-table-edit-td">心理：<font color="#ff0000">*</font></td>
			  <td class="l-table-edit-td"><textarea id="psychicology" onchange="check1()" ></textarea></td>
			  <td class="l-table-edit-td">备注：</td>
			  <td class="l-table-edit-td"><textarea id=remark ></textarea></td>
			</tr>			 						
			<tr>
				<th align="center" class="l-table-edit-td"colspan="3"><div id="result" style="color: red;"></div><div id="result1" style="color: red;"></div></th>								
			</tr>
			<tr>
				<td align="right" class="l-table-edit-td"></td>	
				<td align="right" class="l-table-edit-td"></td>								 
				<td align="right" class="l-table-edit-td"><input type="submit" value="添&nbsp;&nbsp;加" id="Button1" class="l-button l-button-submit" /></td>
			</tr>
		</table>
		<br />
	</form>
