...
<body style="padding: 10px">
	<form name="form1" id="form1" method="post" namespace="/system" action="Manage_justicelendadd.action" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			<tr>
				<td align="right" class="l-table-edit-td" width="80px">标题:</td>
				<td align="left" class="l-table-edit-td">
				<input width="40" height="20" name="certify.title" id="title" type="text" onchange="check()" /></td>
				<td align="right"></td>
			</tr>
			<tr>
			...
			<tr>
			<th colspan="3"><div id="result" style="color: red;font-size: 12px;" ></div></th>
			</tr>
			<tr>
