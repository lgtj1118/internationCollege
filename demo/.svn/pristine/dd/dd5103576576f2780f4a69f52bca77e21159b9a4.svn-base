...
<body style="padding: 10px">
	<!-- <form name="form1" id="form1" method="post" action="Class_classaddbytxt.action" namespace="/system" enctype="multipart/form-data"> -->
		<form name="form1" id="form1" method="post" action="Manage_batchSetSemesterCourse.action" namespace="/system" enctype="multipart/form-data">
		<table cellpadding="0" cellspacing="0" class="l-table-edit">
			...
			<tr>
			  ...
			  <td colspan="2">
			  	请按照课程编号、教室类型、任课老师编号、上课班级编号的顺序组织文件，每个上课班级占一个单元格。
